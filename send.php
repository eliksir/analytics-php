...
require(__DIR__ . "/lib/SegmentIo.php");
...
SegmentIo::init($args["secret"], array(
  "debug" => true,
...
foreach ($lines as $line) {
  ...
  $type = $payload["type"];
  $ret = call_user_func_array(array("SegmentIo", $type), array($payload));
  if ($ret) $successful++;
  $total++;
  if ($total % 100 === 0) SegmentIo::flush();
}
